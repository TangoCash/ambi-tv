...
static int*
ambitv_udpraw_ptr_for_output(struct ambitv_udpraw_priv* udpraw, int output, int* led_str_idx, int* led_idx)
{
    int idx = 0, *ptr = NULL;
...
static int
ambitv_udpraw_map_output_to_point(
...
static int
ambitv_udpraw_commit_outputs(struct ambitv_sink_component* component)
{
    int ret = -1;
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
static void
ambitv_udpraw_clear_leds(struct ambitv_sink_component* component)
{
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;

    if (NULL != udpraw->grb && udpraw->sockfd >= 0)
    {
        int i;
...
static int
ambitv_udpraw_set_output_to_rgb(
    struct ambitv_sink_component* component,
    int idx,
    int r,
    int g,
    int b)
{
    ...
    if (NULL != outp)
    {
        ...
        if(r < udpraw->intensity_min[0]*2.55) r = udpraw->intensity_min[0]*2.55;
        if(g < udpraw->intensity_min[1]*2.55) g = udpraw->intensity_min[1]*2.55;
        if(b < udpraw->intensity_min[2]*2.55) b = udpraw->intensity_min[2]*2.55;
...
static int
ambitv_udpraw_num_outputs(struct ambitv_sink_component* component)
{
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
static int
ambitv_udpraw_start(struct ambitv_sink_component* component)
{
    int ret = 0;
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
static int
ambitv_udpraw_stop(struct ambitv_sink_component* component)
{
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
static int
ambitv_udpraw_configure(struct ambitv_sink_component* component, int argc, char** argv)
{
    int i, c, ret = 0;
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
static void
ambitv_udpraw_print_configuration(struct ambitv_sink_component* component)
{
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
void
ambitv_udpraw_free(struct ambitv_sink_component* component)
{
    int i;
    struct ambitv_udpraw_priv* udpraw =
        (struct ambitv_udpraw_priv*)component->priv;
...
{
    struct ambitv_sink_component* udpraw =
        ambitv_sink_component_create(name);

    if (NULL != udpraw)
    {
        int i;
        struct ambitv_udpraw_priv* priv =
            (struct ambitv_udpraw_priv*)malloc(sizeof(struct ambitv_udpraw_priv));
