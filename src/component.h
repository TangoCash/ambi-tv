...
int ambitv_component_enable(void *component);

void *ambitv_component_find_by_name(const char *name);

void *ambitv_component_find_in_group(const char *name, int active);

void ambitv_component_print_configuration(void *component);

int ambitv_component_activate(void *component);

int ambitv_component_deactivate(void *component);


struct ambitv_source_component *
ambitv_source_component_create(const char *name);

void ambitv_source_component_distribute_to_active_processors(
...
void ambitv_source_component_free(struct ambitv_source_component *component);
...
void ambitv_processor_component_free(struct ambitv_processor_component *component);
...
void ambitv_sink_component_free(struct ambitv_sink_component *component);
