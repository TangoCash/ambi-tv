	...
	int b)
{
	...
	if (NULL != outp)
	{
		...
		if (r < uart->intensity_min[0] * 2.55)
			r = uart->intensity_min[0] * 2.55;
		if (g < uart->intensity_min[1] * 2.55)
			g = uart->intensity_min[1] * 2.55;
		if (b < uart->intensity_min[2] * 2.55)
			b = uart->intensity_min[2] * 2.55;
