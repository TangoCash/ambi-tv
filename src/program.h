...
int ambitv_program_enable(struct ambitv_program *program);

struct ambitv_program *
ambitv_program_create(const char *name, int argc, char **argv);

void ambitv_program_free(struct ambitv_program *program);

int ambitv_program_run(struct ambitv_program *program);

int ambitv_program_stop_current();
