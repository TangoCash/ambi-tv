...
int ambitv_video_fmt_avg_rgb_for_block(unsigned char *rgb, const void *pixbuf, int x, int y, int w, int h, int bytesperline,
	enum ambitv_video_format fmt, int coarseness);

int ambitv_video_fmt_detect_crop_for_frame(
